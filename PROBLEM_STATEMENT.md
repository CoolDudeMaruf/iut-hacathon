...
> Hackathon Problem Statement (Preliminary Round) v1.2
...
It would be great to show a **top-view office layout** (given at the end of the doc) on the dashboard with lights, fans, chairs, tables, and other assets where device states will be reflected visually — for example, lights should glow when ON, and fans should animate when running **(BONUS Points).**
...
The boss still wants to be able to check things without opening a browser — the Discord bot is his quick-access remote control.
...
**Rooms (left to right):** Drawing Room · Work Room 1 · Work Room 2 — with an Entry/Door at the bottom center.
...
| --- | --- | --- |
| 2 Fans | 2 Fans | 2 Fans |
| 3 Lights | 3 Lights | 3 Lights |
